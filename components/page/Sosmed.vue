        ...
        <div id="sosmed-section" class="max-w-3xl mx-auto grid lg:grid-cols-2 grid-cols-1 lg:max-w-7xl px-4 lg:px-8 md:justify-between md:space-x-5 md:flex mb-5">
            ...
            <div class="w-full">
                ...
                <div class="block mb-3">
                    ...
                    <textarea class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="akun1,akun2,akun3,akun4"></textarea>
